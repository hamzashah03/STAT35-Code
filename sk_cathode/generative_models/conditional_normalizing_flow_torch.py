...
class ConditionalNormalizingFlow(BaseEstimator):
    ...
    def load_best_model(self):
        ...
        # best_epoch = np.argmin(val_losses) - 1  # includes pre-training loss              Initialisation is causing nan-values for loss
        best_epoch = np.nanargmin(val_losses) - 1  # includes pre-training loss         ensuring the argmin doesn't count nan values
